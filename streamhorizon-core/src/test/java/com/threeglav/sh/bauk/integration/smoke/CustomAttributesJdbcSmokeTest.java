...
public class CustomAttributesJdbcSmokeTest {
	...
	public static void start() throws Exception {
		...
		Assert.assertTrue(testSetup.setupTestEnvironment("/customAttributesSimpleJdbcLoadingFeedConfig.xml"));
	...
	public void testSimpleJDBCNoHeader() throws Exception {
		...
		Assert.assertEquals("11111", firstRow.get("f2"));
		Assert.assertEquals("22222", firstRow.get("f3"));
