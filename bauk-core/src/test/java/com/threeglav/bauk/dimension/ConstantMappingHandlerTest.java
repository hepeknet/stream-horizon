...
public class ConstantMappingHandlerTest {
	...
	public void testSimple() {
		...
		hvalues.put("h1", "a");
		hvalues.put("h2", "b");
		Assert.assertEquals("a", cmh.getBulkLoadValue(null, hvalues, false));
		hvalues = new HashMap<String, String>();
		hvalues.put("h1", "c");
		hvalues.put("h2", "b");
		Assert.assertEquals("c", cmh.getBulkLoadValue(null, hvalues, false));
		...
		gvalues.put("g1", "a");
		gvalues.put("g2", "b");
		Assert.assertEquals("a", cmh1.getBulkLoadValue(null, gvalues, false));
		gvalues = new HashMap<String, String>();
		gvalues.put("g1", "c");
		gvalues.put("g2", "b");
		Assert.assertEquals("c", cmh1.getBulkLoadValue(null, gvalues, true));
	}
