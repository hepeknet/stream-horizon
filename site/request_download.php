...
if (!isset($_POST["email"])){
  ?>
    <h2>Get the latest version of StreamHorizon platform</h2>
 ...
 <?php 
  ...
  if (isset($_POST["email"])){
	...
	mail("borisha.zivkovic@gmail.com","Your trial version of StreamHorizon DataProcessingPlatform",$message,"From: support@threeglav.com\n");
