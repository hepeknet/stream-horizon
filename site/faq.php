...
<div class="servicess center part clearfix">
  <header class="title">
   ...
   <ol class="readable">
	  <li><a href="#a5" class="more">What is recommended way to start using StreamHorizon?</a></li>
	  ...
	  <li><a href="#a3" class="more">How does StreamHorizon licensing work?</a></li>
    </ol>
  <p/>
  <section class="content">
	<article id="a5" class="detail">
      <h3>What is recommended way to start using StreamHorizon?</h3>
	  <p>
...
Upon decision to proceed with purchase of StreamHorizon platform our technical staff will be in touch with you do discuss best deployment strategy, licensed copy of software including guides and manuals will be provided. 
	...
	<article id="a4" class="detail">
	  ...
	  <p>
		...
		<ul>
			...
			<li>Decent CPU</li>
			<li>500MB of RAM</li>
			<li>Oracle JDK 1.7 or higher</li>
		</ul>
	  </p>
      <p>
	...
	<article id="a3" class="detail">
      <h3>How does StreamHorizon licensing work?</h3>
      <p>
